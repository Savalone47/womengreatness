				...
				<div class="box-body box-profile">
					<div class="col-md-3">
						<div class="pic_size" id="image-holder">
							<center> <img class="thumb-image setpropileam" src="<?php echo base_url();?>/assets/images/events/<?=$events[0]->ev_picture?>" alt="User profile picture"></center>
						</div>
						<br>
						<div class="fileUpload btn btn-success wdt-bg">
							...
							<input type="hidden" name="ev_picture_old" value="<?=$events[0]->ev_picture?>" />
						</div>
					</div>
					<div class="col-md-8">
							<input type="hidden"  name="ev_id" value="<?=$event->ev_id?>" required="required" >
						
						<div class="form-group has-feedback clear-both">
							<label for="exampleInputname">Title:</label>
							<input type="text"  name="ev_title" value="<?=$events[0]->ev_title?>" required="required" class="form-control" placeholder="Title">
							<span class="glyphicon glyphicon-userr form-control-feedback"></span>
						</div>
						<div class="form-group has-feedback clear-both">
							<label for="ev_description">Description:</label>
							<textarea class="form-control" name="ev_description"><?=$events[0]->ev_description?></textarea>
							<span class="glyphicon glyphicon-userr form-control-feedback"></span>
						</div>
						...
						<div class="form-group has-feedback clear-both">
							...
							<input type="date"  name="ev_date" value="<?=$events[0]->ev_date?>" required="required" class="form-control"
							<span class="glyphicon glyphicon-userr form-control-feedback"></span>
						</div>
						...
						<div class="form-group has-feedback clear-both">
							...
							<input type="text"  name="ev_city" value="<?=$events[0]->ev_city?>" required="required" class="form-control" placeholder="City">
							<span class="glyphicon glyphicon-userr form-control-feedback"></span>
						</div>
						<div class="form-group has-feedback clear-both">
							<label for="exampleInputname">Place:</label>
							<input type="text"  name="ev_place" value="<?=$events[0]->ev_place?>" required="required" class="form-control" placeholder="Place">
							<span class="glyphicon glyphicon-userr form-control-feedback"></span>
						</div>

						<div class="form-group has-feedback clear-both">
							<label for="exampleInputname">Price:</label>
							<input type="number" name="ev_price" value="<?=$events[0]->ev_price?>" required="required" class="form-control">
							<span class="glyphicon glyphicon-userr form-control-feedback"></span>
						</div>
						<div class="form-group has-feedback">
