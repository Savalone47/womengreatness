...
<div class="content-wrapper clearfix">
	...
	<div class="col-md-12 form f-label">
		...
		<div class="box-header with-border">
              	<h3 class="box-title">Ressource Add</h3>
            </div>
			<form action='<?php echo site_url('ressource/add')?>' method='POST'>
				<div class="box-body">
					<div class="row clearfix">
						<div class="col-md-6">
							<label for="ressource_title" class="control-label"><span class="text-danger">*</span>ressource Title</label>
							<div class="form-group">
								<input type="text" name="ressource_title" value="<?php echo $this->input->post('ressource_title'); ?>" class="form-control" id="ressource_title" />
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								<input type="text" name="ressource_link" value="<?php echo $this->input->post('ressource_link'); ?>" class="form-control" id="ressource_link" />
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								<input type="text" name="ressource_source" value="<?php echo $this->input->post('ressource_source'); ?>" class="form-control" id="ressource_source" />
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								<textarea name="ressource_content" class="form-control" id="ressource_content"><?php echo $this->input->post('ressource_content'); ?></textarea>
