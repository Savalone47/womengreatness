...
<html>
    <head>
        ...
        <title>womengreatness_blog_actu_db</title>
        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="" class="logo">
                    ...
                    <span class="logo-mini">womengreatness_blog_actu_db</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg">womengreatness_blog_actu_db</span>
                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
						...
						<li>
                            <a href="#">
                                <i class="fa fa-desktop"></i> <span>Actuality</span>
                            </a>
						...
						<li>
                            <a href="#">
                                <i class="fa fa-desktop"></i> <span>Category Actuality</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
						...
						<li>
                            <a href="#">
                                <i class="fa fa-desktop"></i> <span>Category Blog</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
						...
						<li>
                            <a href="#">
                                <i class="fa fa-desktop"></i> <span>Comment</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
								...
								<li>
                                    <a href="<?php echo site_url('comment_admin/index');?>"><i class="fa fa-list-ul"></i> Listing</a>
                                </li>
							</ul>
                        </li>
						<li>
                            <a href="#">
                                <i class="fa fa-desktop"></i> <span>Item Blog</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('item_blog/add');?>"><i class="fa fa-plus"></i> Add</a>
                                </li>
								<li>
						...
						<li>
                            <a href="#">
                                <i class="fa fa-desktop"></i> <span>View Blog</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
