<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
            ...
            <?php echo form_open('comment_admin/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="comment_item_id" class="form-control">
								...
								{
									$selected = ($item_blog['item_id'] == $this->input->post('comment_item_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="comment_name_user" value="<?php echo $this->input->post('comment_name_user'); ?>" class="form-control" id="comment_name_user" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="comment_content" class="form-control" id="comment_content"><?php echo $this->input->post('comment_content'); ?></textarea>
