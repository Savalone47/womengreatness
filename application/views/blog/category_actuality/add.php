...
<div class="content-wrapper clearfix">
	...
	<div class="col-md-12 form f-label">
		...
		<div class="box-header with-border">
              	<h3 class="box-title">Category Actuality Add</h3>
            </div>
            <?php echo form_open('category_actuality/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="category_descriptionn" class="form-control" id="category_descriptionn"><?php echo $this->input->post('category_descriptionn'); ?></textarea>
