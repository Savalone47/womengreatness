	...
	<main class="main">
		<section class="promo-primary">
			<picture>
				<source srcset="<?=base_url()?>vectors/img/about.jpg" media="(min-width: 992px)"/><img class="img--bg" src="<?=base_url()?>vectors/img/about.jpg" alt="img"/>
			</picture>
				...
				<div class="row align-items-center">
					<div class="col-lg-6 col-xl-5">
						<div class="img-box"><img class="img--layout" src="<?=base_url()?>vectors/img/about_layout-reverse.png" alt="img"/>
							<div class="img-box__img"><img class="img--bg" src="<?=base_url()?>vectors/img/about_2.png" alt="img"/></div>
						</div>
					</div>
		...
		<section class="section video-block no-padding-top">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<div class="video-frame"><img class="img--bg" src="<?=base_url()?>vectors/img/video_frame.png" alt="frame"/><a class="video-trigger video-frame__trigger" href="https://www.youtube.com/watch?v=_sI_Ps7JSEk"><span class="video-frame__icon"><i class="fa fa-play" aria-hidden="true"></i></span><span class="video-frame__text">Watch our video</span></a><img class="video-frame__img-layout" src="<?=base_url()?>vectors/img/video_frame-layout.png" alt="layout"/></div>
					</div>
				</div>
			</div>
		</section>
			...
			<div class="container">
				...
				<div class="row offset-margin">
					<div class="col-sm-6 col-lg-3">
						<div class="icon-item">
							<div class="icon-item__img"><img class="img--layout" src="<?=base_url()?>vectors/img/icon_1.png" alt="img"/><span class="js-counter">20</span></div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="icon-item">
							<div class="icon-item__img"><img class="img--layout" src="<?=base_url()?>vectors/img/icon_2.png" alt="img"/><span class="js-counter">32</span></div>
							<div class="icon-item__text">
								<p>Country</p>
							</div>
						</div>
					...
					<div class="col-sm-6 col-lg-3">
						<div class="icon-item">
							<div class="icon-item__img"><img class="img--layout" src="<?=base_url()?>vectors/img/icon_3.png" alt="img"/><span class="js-counter">200 </span><span>+</span></div>
							<div class="icon-item__text">
					...
					<div class="col-sm-6 col-lg-3">
						<div class="icon-item">
							<div class="icon-item__img"><img class="img--layout" src="<?=base_url()?>img/icon_4.png" alt="img"/><span class="js-counter">65 </span><span>b</span></div>
							<div class="icon-item__text">
				...
				<div class="row margin-bottom">
					<div class="col-sm-6 col-lg-4 col-xl-3">
						...
						<div class="team-item team-item--rounded">
							...
							<div class="team-item__img-holder"><img class="img--layout" src="<?=base_url()?>img/team_1.png" alt="layout"/>
								<div class="team-item__img"><img class="img--bg" src="<?=base_url()?>vectors/img/team_1.jpg" alt="teammate"/></div>
							</div>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						...
						<div class="team-item team-item--rounded">
							...
							<div class="team-item__img-holder"><img class="img--layout" src="<?=base_url()?>vectors/img/team_2.png" alt="layout"/>
								<div class="team-item__img"><img class="img--bg" src="<?=base_url()?>vectors/img/team_2.jpg" alt="teammate"/></div>
							</div>
							<div class="team-item__description">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						...
						<div class="team-item team-item--rounded">
							...
							<div class="team-item__img-holder"><img class="img--layout" src="<?=base_url()?>vectors/img/team_3.png" alt="layout"/>
								<div class="team-item__img"><img class="img--bg" src="<?=base_url()?>vectors/img/team_3.jpg" alt="teammate"/></div>
							</div>
							<div class="team-item__description">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						...
						<div class="team-item team-item--rounded">
							...
							<div class="team-item__img-holder"><img class="img--layout" src="<?=base_url()?>vectors/img/team_4.png" alt="layout"/>
								<div class="team-item__img"><img class="img--bg" src="<?=base_url()?>vectors/img/team_4.jpg" alt="teammate"/></div>
							</div>
							<div class="team-item__description">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						...
						<div class="team-item team-item--rounded">
							...
							<div class="team-item__img-holder"><img class="img--layout" src="<?=base_url()?>vectors/img/team_5.png" alt="layout"/>
								<div class="team-item__img"><img class="img--bg" src="<?=base_url()?>vectors/img/team_5.jpg" alt="teammate"/></div>
							</div>
							<div class="team-item__description">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						...
						<div class="team-item team-item--rounded">
							...
							<div class="team-item__img-holder"><img class="img--layout" src="<?=base_url()?>vectors/img/team_6.png" alt="layout"/>
								<div class="team-item__img"><img class="img--bg" src="<?=base_url()?>vectors/img/team_6.jpg" alt="teammate"/></div>
							</div>
							<div class="team-item__description">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						...
						<div class="team-item team-item--rounded">
							...
							<div class="team-item__img-holder"><img class="img--layout" src="<?=base_url()?>vectors/img/team_7.png" alt="layout"/>
								<div class="team-item__img"><img class="img--bg" src="<?=base_url()?>vectors/img/team_7.jpg" alt="teammate"/></div>
							</div>
							<div class="team-item__description">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						...
						<div class="team-item team-item--rounded">
							...
							<div class="team-item__img-holder"><img class="img--layout" src="<?=base_url()?>vectors/img/team_8.png" alt="layout"/>
								<div class="team-item__img"><img class="img--bg" src="<?=base_url()?>vectors/img/team_8.jpg" alt="teammate"/></div>
							</div>
							<div class="team-item__description">
