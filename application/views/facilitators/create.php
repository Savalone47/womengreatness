	...
	<div class="col-md-12 form f-label">
		...
		<div class="box box-success pad-profile">
			<div class="box-header with-border">
				<h3 class="box-title">New Facilitators <small></small></h3>
			</div>
			<?=validation_errors()?>
			<?=form_open_multipart('Facilitators/create')?>
			<div class="box-body box-profile">
				...
				<div class="col-md-8">
					<h3>Facilitators Informations:</h3>
					<div class="form-group has-feedback clear-both">
						<label for="exampleInputname">Name:</label>
						<input type="text"  name="faci_name" required="required" class="form-control" placeholder="Your name please">
						<span class="glyphicon glyphicon-userr form-control-feedback"></span>
					</div>
					<div class="form-group has-feedback clear-both">
						<label for="ev_description">Emails:</label>
						<input type="text"  name="faci_email" required="required" class="form-control" placeholder="Your Email please">
						<span class="glyphicon glyphicon-userr form-control-feedback"></span>
					</div>

					<div class="form-group has-feedback clear-both">
						<label for="exampleInputname">Phone:</label>
						<input type="text"  name="faci_phone" required="required" class="form-control" placeholder="Your phone please">
						<span class="glyphicon glyphicon-userr form-control-feedback"></span>
					</div>
					<div class="form-group has-feedback">
						<label for="faci_country">Countries:</label>
					...
					<div class="form-group has-feedback clear-both">
						...
						<input type="text" name="faci_organisation" required="required" class="form-control" placeholder="Your Organisation">
						<span class="glyphicon glyphicon-userr form-control-feedback"></span>
					</div>
					<div class="form-group has-feedback clear-both">
						<label for="exampleInputname">Position:</label>
						<input type="text" name="faci_position" required="required" class="form-control" placeholder="Your Place">
						<span class="glyphicon glyphicon-userr form-control-feedback"></span>
					</div>
