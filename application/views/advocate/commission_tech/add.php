    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Commission Tech Add</h3>
            </div>
            <?php echo form_open('commission_tech/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="nom_commission" class="control-label"><span class="text-danger">*</span>Nom Commission</label>
						<div class="form-group">
							<input type="text" name="nom_commission" value="<?php echo $this->input->post('nom_commission'); ?>" class="form-control" id="nom_commission" />
