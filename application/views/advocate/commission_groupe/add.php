    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Commission Groupe Add</h3>
            </div>
            <?php echo form_open('commission_groupe/add'); ?>
          	<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_commission" class="form-control">
								...
								{
									$selected = ($commission_tech['id'] == $this->input->post('id_commission')) ? ' selected="selected"' : "";
